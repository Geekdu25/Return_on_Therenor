...
class InputMapping(object):
    ...
    actions = (
        "Avancer", "Reculer", "Aller à droite", "Aller à gauche", "Monter la caméra", "Descendre la caméra", "Caméra à droite", "Caméra à gauche",
        "Courir", "Interagir", "Inventaire", "Changer le point de vue", "Recentrer"
    )
